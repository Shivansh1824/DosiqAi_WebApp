      ...
      <div className="gsap-screen-nav flex items-center justify-between gap-4 flex-wrap bg-white px-5 py-3.5 rounded-2xl border border-slate-200/80 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-bold text-slate-700 hover:text-emerald-700 bg-slate-100 hover:bg-emerald-50 px-3 py-2 rounded-xl border border-slate-200/80 hover:border-emerald-200 transition-colors"
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 flex-wrap mb-3">
                  ...
                  {/* View Original Document Pill */}
                  <button
                    type="button"
                    onClick={() => setShowDocPreview(true)}
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-600 hover:text-emerald-700 bg-slate-100 hover:bg-emerald-50 px-3 py-1 rounded-full border border-slate-200/80 hover:border-emerald-200 transition-colors cursor-pointer"
                    title="View original uploaded prescription"
                  >
